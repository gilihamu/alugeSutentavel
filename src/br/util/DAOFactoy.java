...
import br.dao.AluguelDAO;
import br.dao.CategoriaObjetoDAO;
...
public class DAOFactoy {
	...
	public static AluguelDAO criarAluguel() {
		AluguelDAO dao = new AluguelDAO();
		dao.setSession(JpaUtil.getEntityManager());
		return dao;
	}	
	public static EstadoDAO criarEstado() {
	...
	public static CategoriaObjetoDAO criarCategoriaObjeto() {
		CategoriaObjetoDAO dao = new CategoriaObjetoDAO();
		dao.setSession(JpaUtil.getEntityManager());
		return dao;
	}
